...
async def profile_retrieve(api_config_override: Optional[APIConfig] = None) -> UserProfile:
...
async def profile_update(data: UserProfile, api_config_override: Optional[APIConfig] = None) -> UserProfile:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def profile_partial_update(
    data: PatchedUserProfile, api_config_override: Optional[APIConfig] = None
) -> UserProfile:
    api_config = api_config_override if api_config_override else APIConfig()
