...
async def auth_login_create(api_config_override: Optional[APIConfig] = None) -> None:
...
async def auth_logout_create(api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
