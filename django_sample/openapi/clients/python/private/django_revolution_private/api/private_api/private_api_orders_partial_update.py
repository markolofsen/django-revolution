...
from ...models.patched_order_request import PatchedOrderRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/private_api/orders/{id}/",
    }

    if isinstance(body, PatchedOrderRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedOrderRequest): Serializer for Order model.
        body (PatchedOrderRequest): Serializer for Order model.
        body (PatchedOrderRequest): Serializer for Order model.
