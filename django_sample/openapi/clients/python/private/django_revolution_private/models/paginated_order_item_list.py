...
T = TypeVar("T", bound="PaginatedOrderItemList")
...
class PaginatedOrderItemList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = OrderItem.from_dict(results_item_data)
        ...
        paginated_order_item_list.additional_properties = d
        return paginated_order_item_list
