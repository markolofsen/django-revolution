...
def products_create(
    data: Product, api_config_override: Optional[APIConfig] = None
) -> Product:
    api_config = api_config_override if api_config_override else APIConfig()
...
def products_update(
    id: int, data: Product, api_config_override: Optional[APIConfig] = None
) -> Product:
    api_config = api_config_override if api_config_override else APIConfig()
...
def products_order_items_destroy(
    id: int, product_id: int, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
