...
async def order_items_create(data: OrderItem, api_config_override: Optional[APIConfig] = None) -> OrderItem:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def order_items_retrieve(id: int, api_config_override: Optional[APIConfig] = None) -> OrderItem:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def order_items_update(id: int, data: OrderItem, api_config_override: Optional[APIConfig] = None) -> OrderItem:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def order_items_destroy(id: int, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def order_items_partial_update(
