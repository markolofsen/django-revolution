...
async def api_public_api_posts_create(
...
async def api_public_api_posts_retrieve(
...
async def api_public_api_posts_update(
...
async def api_public_api_posts_destroy(
    id: int, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
